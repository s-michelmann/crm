...
load('../../data/matlab_flowershow_m.mat')
load('../../data/matlab_flowershow_l.mat')
...
cell_activity = tdfread("../../data/File110Ron.txt").x0x2D2;
...
cell_activity4 = tdfread("../../data/File130Gn.txt").x0x2D2; %
cell_activity5 = tdfread("../../data/File278Gon.txt").x0x2D2; %
cell_activity6 = tdfread("../../data/File284Gon.txt").x01; %
cell_activity7 = tdfread("../../data/File287Gon.txt").x0x2D2; %

%%

X = [cell_activity1, cell_activity2, cell_activity3];
X = [cell_activity4, cell_activity5, cell_activity6, cell_activity7];
% X = [cell_activity1, cell_activity2, cell_activity3, cell_activity4, cell_activity5, cell_activity6, cell_activity7];
X = circshift(X, -3)';

X = (X - mean(X(:))) ./ std(X(:));
Y = top_latents_m(751:9750,:)' - top_latents_l(751:9750,:)'; % chop off first 5s frames
...
[w_x1, w_y1] = crm(C_xx, C_yy, C_xy, 0*D_xy, gamma=10000);
...
[w_x2, w_y2] = crm(C_xx, C_yy, C_xy, D_xy, gamma=10000);
