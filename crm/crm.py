...
def crm(C_xx, C_yy, C_xy, D_xy, f=1, gamma=None):
    """
    Unified CRM solver — single-init dense path (f-th component).

    Computes weight vectors w_x, w_y and optimal lambda3 for given covariance-like matrices.
    Usage:
      w_x, w_y, lambda3 = crm(C_xx, C_yy, C_xy, D_xy, f=1, gamma=0.05)
